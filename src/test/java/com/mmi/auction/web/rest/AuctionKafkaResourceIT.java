...
import com.mmi.auction.config.EmbeddedKafka;
import com.mmi.auction.config.KafkaSseConsumer;
import com.mmi.auction.config.KafkaSseProducer;
...
class AuctionKafkaResourceIT {
    ...
    void producesMessages() throws InterruptedException {
        client.post().uri("/api/auction-kafka/publish?message=value-produce").exchange().expectStatus().isNoContent();
